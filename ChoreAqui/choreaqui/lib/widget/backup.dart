...
class Nackup extends StatelessWidget {
  final Universidade universidade;
  final bool horizontal;

  Nackup(this.universidade, {this.horizontal = true});
  ...
  Widget build(BuildContext context) {
    final planetThumbnail = new Container(
        ...
        // child: new Hero(
        //     tag: "planet-hero-${universidade.id}",
        //
        // ),
        );
    ...
    Widget _planetValue({String value, String image}) {
      return new Container(
        child: new Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
          ...
          new Text(universidade.name, style: Style.smallTextStyle),
        ]),
      );
    }
    ...
    final planetCardContent = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Text(universidade.name, style: Style.commonTextStyle),
          // new Separator(),
          new Row(
            ...
            children: <Widget>[
              new Expanded(
                  flex: !horizontal ? 1 : 0,
                  child: _planetValue(
                      value: universidade.name, image: 'assets/img/mars.png')),
              new Container(
